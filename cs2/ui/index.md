# ui
Create and manage menu elements (groupboxes, checkboxes, sliders, buttons, etc.) in the cheat interface. Use `config_name` with [config](/cs2/config/) get/set to read and save values.
