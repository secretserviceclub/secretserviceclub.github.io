...
secret.steam.set_presence("steam_display", "#Status_Generic")
secret.steam.set_presence("status", "daz is cool")
secret.steam.set_presence("generic", "daz is cool")
secret.steam.set_presence("connect", "+connect 0.0.0.0:10000")
```
